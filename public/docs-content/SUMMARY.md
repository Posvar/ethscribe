...
* [Why Ethscribe exists](overview/why-ethscribe.md)
* [The core thesis](overview/core-thesis.md)
* [Principles and vocabulary](overview/principles-and-vocabulary.md)

## Foundations

* [Ethscriptions primer](foundations/ethscriptions.md)
* [Byte-perfect identity](foundations/byte-perfect-identity.md)
* [Claims, evidence, and limits](foundations/claims-evidence-and-limits.md)
...
* [Path to autonomy](roadmap/path-to-autonomy.md)
