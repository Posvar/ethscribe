...
Early historical eligibility is decided by a named curator applying a published rubric. Later marketplace custody, bids, refunds, transfers, and fees are enforced by contract. The system becomes more distributed only when actual scale and value justify the complexity.
